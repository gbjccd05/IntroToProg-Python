...
# Glenn B. Dacones,5.13.2022,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
...
while (True):
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        strPriority = strPriority.capitalize()
    ...
    # Step 5 - Remove a new item from the list/Table
        ...
        strRemove = strRemove.capitalize()
        for row in lstTable:
    ...
    # Step 6 - Save tasks to the ToDoToDoList.txt file
        ...
        objFile.close()
        print("Your data has been saved to", strFile + "!")
        continue
